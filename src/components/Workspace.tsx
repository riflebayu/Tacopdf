          ...
          {tool.id === 'html-to-pdf' ? (
            ...
            <div className="space-y-4">
              {(tool.id === 'add-watermark' || tool.id === 'add-page-numbers') && uploadedFiles.length > 0 && !uploadedFiles.some(f => lockedFileIds.has(f.id)) ? (
                ...
                className={`border-2 border-dashed rounded-xl p-5 py-6 md:p-10 flex flex-col items-center justify-center text-center cursor-pointer transition-all ${
                  isDragActive 
              ...
              >
                ...
                />
                <LucideIcon name="UploadCloud" size={48} className="text-primary-container mb-2 md:mb-4 scale-75 md:scale-100" />
                ...
                <button
                  ...
                  className="mt-3 md:mt-6 px-5 py-2 md:px-6 md:py-2.5 bg-primary text-on-primary font-bold rounded-lg hover:bg-primary/90 transition-colors uppercase tracking-wide text-[10px] md:text-xs"
                >
