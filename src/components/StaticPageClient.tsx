      ...
      case 'about':
        return (
          <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-start">
            ...
            <div className="w-full md:w-[35%] flex flex-col items-center gap-5 bg-surface-container-lowest p-8 rounded-3xl border border-outline-variant/50 shadow-sm sticky top-24 shrink-0">
              <img 
                src="/profile.webp" 
                alt="Founder" 
                className="w-36 h-36 md:w-48 md:h-48 rounded-full object-cover shadow-lg border-[6px] border-surface"
              />
              <div className="flex items-center justify-center gap-5 mt-2">
                <a href="https://facebook.com/baylightyear04/" target="_blank" rel="noopener noreferrer" className="p-3 rounded-full bg-blue-600/10 text-blue-600 hover:bg-blue-600 hover:text-white hover:-translate-y-1 transition-all duration-300" title="Facebook">
                ...
                <a href="https://www.instagram.com/bay.lightyear/" target="_blank" rel="noopener noreferrer" className="p-3 rounded-full bg-pink-600/10 text-pink-600 hover:bg-pink-600 hover:text-white hover:-translate-y-1 transition-all duration-300" title="Instagram">
            ...
            <div className="w-full md:w-[65%] space-y-10 md:space-y-12">
              {/* Founder Welcome Text */}
              <div className="space-y-5">
                <h3 className="text-3xl md:text-4xl font-extrabold text-primary-container tracking-tight">{t('about.founder.title', 'Creator & Founder')}</h3>
                <p 
                ...
                {[1, 2, 3, 4, 5].map(i => {
                  ...
                  return (
                    <div key={i} className="space-y-3 md:space-y-4">
                      <h3 className="font-bold text-on-surface text-xl md:text-2xl">{title}</h3>
