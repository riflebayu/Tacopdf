...
function NavbarContent({ activeToolId }: NavbarProps) {
  ...
  return (
    <header className="sticky top-0 z-50 bg-[#14120E]/70 backdrop-blur-md border-b border-white/10 transition-all duration-300 w-full">
      <div className="flex justify-between items-center w-full px-4 md:px-8 h-14 md:h-20">
        ...
        <nav className="hidden md:flex items-center gap-6 h-full">
          ...
          <a 
            ...
            className="text-amber-400 hover:text-amber-200 transition-all duration-300 text-sm font-medium ml-2 hover:[text-shadow:0_0_12px_rgba(251,191,36,0.9)] md:hover:scale-105 inline-block"
          >
