    ...
    <section className="bg-surface-container-low border-y border-outline-variant py-8 mt-4">
      <div className="max-w-[1200px] mx-auto px-4 md:px-8 space-y-8">
        ...
        <div className="relative">
          <div ref={bentoRef} className="flex overflow-x-auto scroll-smooth overscroll-x-contain touch-pan-x snap-x snap-mandatory gap-4 pb-4 pt-6 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-6 md:overflow-visible md:pb-0 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']">
        ...
        <div className="max-w-4xl mx-auto space-y-8 text-on-surface-variant text-sm md:text-base leading-relaxed border-t border-outline-variant/40 pt-10">
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              <ul ref={toolsRef} className="flex overflow-x-auto scroll-smooth overscroll-x-contain touch-pan-x snap-x snap-mandatory gap-4 pb-4 md:grid md:grid-cols-2 md:gap-3 md:pl-2 md:overflow-visible md:pb-0 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']">
                {TOOLS.map((tool) => (
