  ...
  return (
    <main className="flex flex-col w-full bg-background">
      ...
      <section
        ...
        id="beranda-atas"
      >
        {/* Anti-AI Slop: Removed radial glow for a cleaner, high-contrast look */}
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          {/* Anti-AI Slop: Clean, structured, functional badges */}
          <div className="grid grid-cols-2 md:flex md:flex-row md:flex-wrap items-center justify-center gap-2 md:gap-3 max-w-sm sm:max-w-md md:max-w-none mx-auto mt-5 md:mt-6 text-[11px] md:text-xs font-bold text-on-surface">
            <span className="flex items-center justify-center gap-1.5 px-3 py-2 md:px-4 md:py-2.5 bg-surface border-2 border-outline-variant hover:border-primary transition-colors text-center">
            ...
            <span className="flex items-center justify-center gap-1.5 px-3 py-2 md:px-4 md:py-2.5 bg-surface border-2 border-outline-variant hover:border-primary transition-colors text-center">
              <ImageOff size={16} className="text-primary shrink-0" />
              <span className="truncate md:overflow-visible">{t('header.badge.noWatermark', 'No Watermark')}</span>
            </span>
            <span className="flex items-center justify-center gap-1.5 px-3 py-2 md:px-4 md:py-2.5 bg-surface border-2 border-outline-variant hover:border-primary transition-colors text-center">
              <CloudOff size={16} className="text-primary shrink-0" />
